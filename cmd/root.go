...
var rootCmd = &cobra.Command{
	Use:   "pdbl",
	Short: "A utility to lookup workloads associated with a Kubernetes Pod Disruption Budget (PDB)",
	Long:  `A utility to lookup workloads associated with a Kubernetes Pod Disruption Budget (PDB)`,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.pdbl.yaml)")
